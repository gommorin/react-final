                ...
                <Col xs="12" md={{ size: 8, offset: 2 }} className="p-0">
                  <FormGroup>
                    <Input
                      ...
                      placeholder="Title"
                      className="text-muted border border-right-0 border-top-0 border-bottom-0 border-secondary rounded-0 "
                    />
                  </FormGroup>
                </Col>
<<<<<<< HEAD
...
=======
                <Col xs="12" md={{ size: 8, offset: 2 }} className="p-0">
>>>>>>> a284cd4acd436fa3f33c25fe4a868fec0c568db4
                  <FormGroup>
                    <Input
                      type="text"
                      value={author}
                ...
                <Col xs="12" md={{ size: 8, offset: 2 }} className="p-0">
                  ...
                  <FormGroup>
                    <Input
                      ...
                      name="time"
                      onChange={this.handleNewPostChange}
                      placeholder="How long does your story take to be read? "
                      className="text-muted border border-right-0 border-top-0 border-bottom-0 border-secondary rounded-0"
                    />
                  </FormGroup>
                </Col>
                ...
                <Col xs="12" md={{ size: 8, offset: 2 }} className="p-0">
                  <Button
                    type="submit"
                    className="w-100 bg-light text-secondary border-light "
                  >
                    Publish
                  </Button>
                </Col>
